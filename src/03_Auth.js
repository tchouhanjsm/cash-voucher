...
function getPortalInfo() {
  ...
  return {
    ...
    propertyName:
      APP_CONFIG.PROPERTY_NAME,

    propertyAddress:
      APP_CONFIG.PROPERTY_ADDRESS,

    pinLength:
      APP_CONFIG.AUTH.PIN_LENGTH
 ...
 */
function resetFailedLoginAttempts_(
  user
) {
